...
## Introducción
Este es un proyecto que busca resolver las necsidades de encontrar, leer, estraer y dar los estados de los vinculos, creando una dependencia que desde su nacimiento que satisface la necesidad del usuario.
...
- Para este proyecto en una proxima iteracion la creacion del codigo se regira por el metodo de testeo TDD
- En una proxima iteracion las funciones seran cambiadas por promesas
